...
// Validate ../../src/app/api/api-key/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/api-key">> = Specific
  const handler = {} as typeof import("../../src/app/api/api-key/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
